...
python tools/inference.py \
    --model-path "./output/trained_models_v2/Qwen3_8B_unsloth_bnb_4bit_lora_r8_sft_gspo_rw_text_visual_20251127_110202_final" \
    --load-in-4bit \
    --prompt-mode "chat" \
    --device-map "auto" \
    --input-prompt "Create a Manim script that draws a red circle and a blue square." \
    --max-new-tokens 2048 \
...
def run_inference(
    ...
    video_output_path: str = typer.Option("./output/inference_results/generated_video.mp4", help="Path to save the generated video."),
    ...
    render_result = manim_evaluator.evaluate_code(model_response, clear_output=False)
